...
const dummyFaqs = [
  ...
  {
    id: 6,
    question: '내가 쓴 글이나 댓글을 삭제하고 싶어요.',
    answer: `앱 내 커뮤니티에서 본인이 작성한 글 또는 댓글의 '삭제' 버튼을 눌러 직접 삭제할 수 있습니다.\n삭제된 글과 댓글은 복구가 불가능하니 신중히 삭제해 주세요.`,
  },
  {
    id: 7,
    question: '탈퇴(계정 삭제)도 가능한가요?',
    answer: `마이페이지 > 회원탈퇴 메뉴에서 계정 삭제를 직접 진행할 수 있습니다.\n계정 삭제 시, 사용자의 모든 데이터(게시글, 댓글, 진단 기록 등)는 즉시 완전히 삭제됩니다.`,
  },
];
